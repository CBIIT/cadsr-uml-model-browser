...
<html>
	...
	<body topmargin="0" bgcolor="#ffffff">
		<script LANGUAGE="JavaScript1.1"
			SRC='<html:rewrite page="/js/JavaScript.js"/>'
					...
					<table Cellpadding="0" Cellspacing="0" border="0">
						<tr>
							<td valign="TOP" align="CENTER" width="1%" colspan="1">
								<a href="javascript:window.close()" target="_top"><html:img
										page="/i/icon_return.gif" alt="Back" border="0" width="32"
										height="32" /> </a>
								<br>
								<font color="brown" face="verdana" size="1">&nbsp;Home&nbsp;</font>
							</td>
							<td valign="TOP" align="CENTER" width="1%" colspan="1">
								<a HREF="javascript:newBrowserWin('/help/','helpWin',700,600)"><html:img
		...
		<table align="center" cellpadding="0" cellspacing="0" width="80%">
			<tbody>
				...
				<tr>
					<td width="100%">
						<img src="/i/beigedot.gif" align="top" border="0" height="1"
							width="99%" alt="">
					</td>
				</tr>
			</tbody>
		...
		<bean:define id="project"
			name="<%=UMLBrowserFormConstants.PROJECT_DETAILS%>"
			type="gov.nih.nci.cadsr.umlproject.domain.Project" />		
		<bean:define id="classificationScheme"
			name="<%=UMLBrowserFormConstants.PROJECT_DETAILS_CS%>"
			type="gov.nih.nci.cadsr.domain.ClassificationScheme" />

		<table align="center" bgcolor="#999966" cellpadding="1"
			...
			<tbody>
				...
				<tr class="OraTabledata">
					...
					<td class="OraFieldText">
						<bean:write name="project" property="version" />
					</td>
				</tr>
				...
				<tr class="OraTabledata">
					...
					<td class="OraFieldText">
						<bean:write name="project" property="longName" />
					</td>
				</tr>
				...
				<tr class="OraTabledata">
					...
					<td class="OraFieldText">
						<bean:write name="project" property="shortName" />
					</td>
				</tr>
				...
				<tr class="OraTabledata">
					...
					<td class="OraFieldText">
						<bean:write name="classificationScheme"
							property="workflowStatusDescription" />
					</td>
				</tr>
		...
		<table align="center" bgcolor="#999966" cellpadding="1"
			...
			<tbody>
				...
				<bean:define id="referenceDocuments" name="classificationScheme"
					property="referenceDocumentCollection" type="java.util.Collection" />
				<bean:define id="rdaMap"
					name="<%=UMLBrowserFormConstants.PROJECT_DETAILS_RDAS%>"
					type="java.util.Map" />
				<logic:empty name="referenceDocuments">
					<tr class="OraTabledata">
						<td class="OraFieldText" colspan="5">
							No reference documents available.
						</td>
					</tr>
				</logic:empty>
				<logic:notEmpty name="referenceDocuments">
					<logic:iterate id="referenceDocument" name="referenceDocuments"
						type="gov.nih.nci.cadsr.domain.ReferenceDocument">
						<tr class="OraTabledata">
							<td class="OraFieldText">
								<bean:write name="referenceDocument" property="name" />
							</td>
							<td class="OraFieldText">
								<bean:write name="referenceDocument" property="type" />
							</td>
							<td class="OraFieldText">
							...
							<td class="OraFieldText">
								<logic:notEmpty name="referenceDocument" property="URL">
									<a href="<%=referenceDocument.getURL()%>"
										target="ReferenceDocumentURL"> <bean:write
											name="referenceDocument" property="URL" /> </a>
								</logic:notEmpty>
							</td>
							<%
							java.util.Collection rdas = (java.util.Collection) ((java.util.Map) rdaMap)
												.get(referenceDocument.getId());
										pageContext.setAttribute("rdas", rdas);
						%>
							<td>
								<logic:present name="rdas">
									<logic:iterate id="rda" name="rdas"
										type="gov.nih.nci.ncicb.cadsr.umlmodelbrowser.dto.ReferenceDocumentAttachment">
										<a
											href="javascript:newBrowserWin('<%=request.getContextPath()%>/umlbrowser/viewRefDocAttachment.do?method=viewReferenceDocumentAttachment&amp;<%=UMLBrowserFormConstants.PROJECT_REFERENCE_DOCUMENT_ATT_NAME%>=<%=rda.getName()%>','ReferenceDocumentAttachemt')">
											<bean:write name="rda" property="name" /> </a>
									</logic:iterate>
								</logic:present>
							</td>
						</tr>
		...
		<bean:define id="contacts"
			name="<%=UMLBrowserFormConstants.PROJECT_DETAILS_CONTACTS%>"
		...
		<table align="center" bgcolor="#999966" cellpadding="1"
			...
			<tbody>
				...
				<logic:empty name="contacts">
					<tr class="OraTabledata">
						<td class="OraFieldText" colspan="6">
							No contacts available.
						</td>
					</tr>
				</logic:empty>
				<logic:iterate id="contact" name="contacts"
					type="gov.nih.nci.cadsr.domain.AdministeredComponentContact">
					<tr class="OraTabledata">
						<td class="OraFieldText">
							<bean:write name="contact" property="rank" />
						</td>
						<logic:present name="contact" property="organization">
							<bean:define id="organization" name="contact"
							...
							<td class="OraFieldText">
								<bean:write name="contact" property="contactRole" />
							</td>
							<bean:define id="comms" name="organization"
								property="contactCommunication" type="java.util.Collection" />
							<td class="OraFieldText">
								<logic:iterate id="comm" name="comms"
									type="gov.nih.nci.cadsr.domain.ContactCommunication">
							...
							<td class="OraFieldText">
								<logic:iterate id="comm" name="comms"
									...
									<logic:equal name="comm" property="type" value="EMAIL">
										<a href="mailto:<%=comm.getValue()%>"> <bean:write
												name="comm" property="value" /> </a>
										<br>
									</logic:equal>
								</logic:iterate>
							</td>
						...
						<logic:present name="contact" property="person">
							...
							<bean:define id="comms" name="person"
								property="contactCommunication" type="java.util.Collection" />
							<td class="OraFieldText">
								<logic:iterate id="comm" name="comms"
									type="gov.nih.nci.cadsr.domain.ContactCommunication">
