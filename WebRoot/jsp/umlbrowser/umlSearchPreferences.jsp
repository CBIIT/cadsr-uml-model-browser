...
<html>
	<head>
		...
		<SCRIPT LANGUAGE="JavaScript1.1"
			SRC='<html:rewrite page="/js/checkbox"/>'></SCRIPT>
		<SCRIPT LANGUAGE="JavaScript1.1"
			SRC='<html:rewrite page="/js/JavaScript.js"/>'></SCRIPT>
		<SCRIPT LANGUAGE="JavaScript1.1">
function save() {
	...
	<body topmargin="0" bgcolor="#ffffff">
						...
						<TR>
							<TD valign="TOP" align="CENTER" width="1%" colspan=1>
								<html:link page="/" target="_top">
									<html:img page="/i/icon_home.gif" alt="Home" border="0"
										width="32" height="32" />
								</html:link>
								<br>
		...
		<html:form action="/umlbrowser/setSearchPreferencesAction.do">
			...
			<table align="center" width=20% Cellpadding=0 Cellspacing=4 border=0>
				<tr>
					<TD valign="TOP" align="CENTER" colspan=1>
						<a href="javascript:save()"> <html:img page="/i/save.gif"
								border="0" alt="Save" /> </a>
					</td>
			...
			<table width="100%">
				<tbody>
					<tr align="left">
						<td class="OraHeaderSubSub" align="left" nowrap="nowrap"
							width="50%">
							UML Model Browser search preferences for this session
						</td>
						<td width="50%" align="right" nowrap>
							<a href="javascript:reset()"> Reset to default search
								preferences </a>
						</td>
					</tr>
					<tr>
						<td colspan="2" align="center">
							<html:img page="/i/beigedot.gif" align="top" border="0"
								height="1" width="99%" />
						</td>
					</tr>
				</tbody>
				...
				<tbody>
					<tr>
						<td valign="top" width="100%">
							<table class="OraBGAccentVeryDark" cellpadding="1"
								cellspacing="1" width="100%">
								<tbody>
									<tr>
										<td colspan="2" class="OraTableColumnHeaderNoBG">
											<html:checkbox
												property="<%=UMLBrowserFormConstants.EXCLUDE_TEST_CONTEXT%>"
												value="true">
												<bean:message
													key="cadsr.umlbrowser.excludeTestContext.label" />
											</html:checkbox>
										</td>
									</tr>
									<tr>
										<td colspan="2" class="OraTableColumnHeaderNoBG">
											<html:checkbox
												property="<%=UMLBrowserFormConstants.EXCLUDE_TRAINING_CONTEXT%>"
												value="true">
												<bean:message
													key="cadsr.umlbrowser.excludeTrainingContext.label" />
											</html:checkbox>
										</td>
									</tr>
								</tbody>
