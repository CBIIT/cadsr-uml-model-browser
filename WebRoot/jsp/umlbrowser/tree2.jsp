...
<f:view>
	...
	<t:document>
		<t:documentHead>
			...
			<script language="JavaScript1.2" src="/js/JavaScript.js"></script>
			...
			<h:form id="umlBrowserTree">
				...
				<t:tree2 id="serverTree" value="#{treeBacker.treeModel}" var="node"
					...
					<f:facet name="Context Folder">
						<h:panelGroup>
							...
							<t:graphicImage value="/i/yellow-folder-closed.png" alt="Context"
								title="Context" rendered="#{!t.nodeExpanded}" border="0" />
					...
					<f:facet name="Container">
						<h:panelGroup style="white-space:nowrap;">
							<t:graphicImage value="/i/container.png" alt="Project"
								title="Container" border="0" />
					...
					<f:facet name="Project Folder">
						<h:panelGroup style="white-space:nowrap;">
							<t:graphicImage value="/i/yellow-folder-open.png" alt="Project"
								title="Project" rendered="#{t.nodeExpanded}" border="0" />
							<t:graphicImage value="/i/yellow-folder-closed.png" alt="Project"
								title="Project" rendered="#{!t.nodeExpanded}" border="0" />
					...
					<f:facet name="SubProject Folder">
						<h:panelGroup style="white-space:nowrap;">
							<t:graphicImage value="/i/yellow-folder-open.png"
								alt="SubProject" title="SubProject" rendered="#{t.nodeExpanded}"
								border="0" />
							<t:graphicImage value="/i/yellow-folder-closed.png"
								alt="SubProject" title="SubProject"
					...
					<f:facet name="Package Folder">
						<h:panelGroup style="white-space:nowrap;">
							<t:graphicImage value="/i/tree-package.gif" alt="Package"
								title="Package" border="0" />
					...
					<f:facet name="Class Node">
						<h:panelGroup style="white-space:nowrap;">
							<t:graphicImage value="/i/tree-class.gif" alt="Class"
								title="Class" border="0" />
