			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td bgcolor="#336699" width="1%" align="LEFT" valign="TOP">
						<html:img page="/i/ctab_open.gif" height="21" width="18"
							border="0" />
					</td>
					<td width="1%" bgcolor="#336699">
						<b><font size="-1" face="Arial" color="#FFFFFF"><%=label%></font>
						</b>
					</td>
					<td bgcolor="#336699" width="1%" align="RIGHT" valign="TOP">
						<html:img page="/i/ctab_close.gif" height="21" width="12"
							border="0" />
					</td>
				</tr>
			</table>
...
<table width="100%" Cellpadding="0" Cellspacing="0" border="0">
	<tr>
		<td align="left" valign="top" width="1%" bgcolor="#336699">
			<html:img page="/i/top_left.gif" width="4" height="25" />
		</td>
...
<table width="100%" Cellpadding="0" Cellspacing="0" border="0">
	<tr>
		<td align="right" valign="top" width="49" height="21"
			bgcolor="#336699">
			<html:img page="/i/left_end_bottom.gif" height="21" width="49" />
		</td>
		<td align="left" valign="top" bgcolor="#FFFFFF" height="21"
			width="100%">
			<html:img page="/i/bottom_middle.gif" height="6" width="100%" />
		</td>
		<td align="LEFT" valign="top" height="21" width="5" bgcolor="#FFFFFF">
			<html:img page="/i/right_end_bottom.gif" height="7" width="5" />
		</td>
	</tr>
</table>
