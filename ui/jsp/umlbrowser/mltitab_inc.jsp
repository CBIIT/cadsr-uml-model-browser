...
<% for(int i=0;i<allLabels.length;i++)
 ...
 <% } else { %>
      <TD bgcolor="#B6B687" width="1%" align=LEFT valign=TOP><IMG SRC="<%=urlPrefix%>/i/tab_open.gif" height=21 width=18 border=0></TD>
      <TD width=1% bgcolor="#B6B687"><font size="-1" face="Arial" color="#000000">
          <a href="<%=urls[i]%>"><%=allLabels[i]%> </a></font></TD>
      <TD bgcolor="#B6B687" width="1%" align=RIGHT valign=TOP><IMG SRC="<%=urlPrefix%>/i/tab_close.gif" height=21 width=12 border=0></TD>
<% } %>
<% }%>
</tr>
</table>
