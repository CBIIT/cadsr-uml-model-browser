...
<% for(int i=0;i<allLabels.length;i++)
 ...
 <%
    ...
    {
 %>
      <TD bgcolor="#336699" width="1%" align=LEFT valign=TOP><IMG SRC="<%=urlPrefix%>/i/ctab_open.gif" alt="ctab open" height=21 width=18 border=0></TD>
      <TD width=1% bgcolor="#336699"><b><font size="-1" face="Arial" color="#FFFFFF">
            <%=allLabels[i]%></font></b>
      </TD>
      <TD bgcolor="#336699" width="1%" align=RIGHT valign=TOP><IMG SRC="<%=urlPrefix%>/i/ctab_close.gif" alt="ctab close" height=21 width=12 border=0></TD>
 <% } else { %>
