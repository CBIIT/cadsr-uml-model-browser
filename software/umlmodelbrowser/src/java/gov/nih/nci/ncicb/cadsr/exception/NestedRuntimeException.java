...
/**
 * Handy class for wrapping Exceptions so to allow a method to throw just the
 * wrapper and not have to throw a whole bunch of Exceptions. (a la
 * RemoteException) printStackTrace() etc. are forwarded to the wrapped
 * Exception. Abstract to force the programmer to extend the class
 */
